import { socials } from "../constants/blocks/socials";
      ...
      <div className="container py-10">
        <div className="flex w-full max-md:flex-col">
          <div className="small-compact flex flex-1 flex-wrap items-center justify-center gap-5">
            <p className="opacity-70 md:py-0 max-md:pb-5">
              Copyright {"\u00A9"}
            </p>
          </div>
          ...
          <ul className="flex flex-1 justify-center gap-3 max-md:mt-5 md:justify-end">
